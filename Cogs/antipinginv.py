...
class antipinginv(commands.Cog):
    ...
    async def on_invite_delete(self, invite):
        try:
          guild = invite.guild
          reason = "Darkz Security | Anti Invite Delete"
    ...
    async def on_message(self, message):
      ...
      if mention in message.content:
        await message.author.ban(reason="Darkz Security | Anti Everyone Ping")
      elif here in message.content:
        await message.author.ban(reason="Darkz Security | Anti Here Ping")
      elif role in message.content:
    	  await message.author.ban(reason="Darkz Security | Anti Role Ping")